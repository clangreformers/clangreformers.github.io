...
![Wang Pu](/assets/imgs/wangpu.jpg "Wang Pu"){: width="300" }

![Wang Pu](/assets/imgs/wangpu_2.png "Wang Pu"){: width="300" }
...
In 1919, the [Preparatory Committee for the Unification of the National Language]({{ site.baseurl }}{% link glossary/preparation.md %}) (abbreviated as "Guoyuhui") was established, and Wang Pu was appointed as a member.
