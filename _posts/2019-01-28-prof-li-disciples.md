...
Professor Li also helped to set up the Peking "Little Chinese Daily". Every Chinese character in this paper was annotated with ZhuYin. If you know ZhuYin alphabet, you can correctly sound out the character. The paper became an effective tool in stemming out illiteracy. The president was [Jialin Xiao]({{ site.baseurl }}{% link people/xiaojialin.md %}), vice president was Shoukang Wang. Contributing editors included Shirong Xuu, [Chongyi Sun]({{ site.baseurl }}{% link people/sunchongyi.md %}), Jichang Niu, and Shankai Wang. All of them were Professor Li's students.
