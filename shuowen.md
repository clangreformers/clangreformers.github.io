    ...
    <div>
      <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="stories-tab" data-bs-toggle="tab" data-bs-target="#stories" type="button" role="tab" aria-controls="stories" aria-selected="true">Stories of Chinese Characters</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="learning-tab" data-bs-toggle="tab" data-bs-target="#learning" type="button" role="tab" aria-controls="learning" aria-selected="false">Learning Chinese</button>
        </li>
      </ul>
        ...
        <div class="tab-pane fade show active" id="stories" role="tabpanel" aria-labelledby="stories-tab">
          <div style="margin-top: 20px;">
            <ul class="nav nav-pills mb-3" id="storiesSubTab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="random-subtab" data-bs-toggle="pill" data-bs-target="#random-content" type="button" role="tab" aria-controls="random-content" aria-selected="true">Daily Word</button>
              </li>
              <li class="nav-item" role="presentation">
                <button class="nav-link" id="list-subtab" data-bs-toggle="pill" data-bs-target="#list-content" type="button" role="tab" aria-controls="list-content" aria-selected="false">Top 600 Dictionary</button>
              </li>
            </ul>
